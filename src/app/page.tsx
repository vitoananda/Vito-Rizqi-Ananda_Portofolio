        ...
        <div className="flex min-h-0 flex-col gap-y-3">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 6.5}>
            <div className="flex justify-center mt-6">
              <Link href="/Vito Rizqi Ananda_Resume.pdf" target="_blank" download>
                <PulsatingButton
                  pulseColor="#808080"
                  className="w-full sm:w-auto bg-black text-white py-2"
                >
                  Download Resume
                </PulsatingButton>
              </Link>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve worked on a variety of projects, from backend API to
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3 mb-10">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed ">
                Have any questions or want to collaborate? Fill out the form
